...
var _djangoReactCsrftoken = __webpack_require__(124);
        ...
        value: function render() {
            ...
            if (this.state.isRegister) {
                button = _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'text', name: 'sap_id', placeholder: 'SAP ID', value: this.state.sapID, onChange: this.handleSAP, required: true }),
                    _react2.default.createElement('input', { type: 'text', name: 'mobile', placeholder: 'Mobile Number', value: this.state.mobileNumber, onChange: this.handlemobileNumber, required: true })
                );
            }
            return _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement('input', { type: 'hidden', name: 'next', value: '{{ request.GET.next }}' })
                    ),
                    _react2.default.createElement(
                        'center',
                        null,
                        _react2.default.createElement(
                            'button',
                            { className: 'btn btn-info btn-block login', name: 'login', style: { textAlign: 'center', width: '100%' }, type: 'submit', disabled: !this.state.formValid && this.state.isRegister },
                            'Login'
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'button',
                            { className: 'btn btn-info btn-block login', name: 'register', style: { textAlign: 'center', width: '100%' }, type: 'submit', onClick: this.addRegister, disabled: !this.state.formValid && this.state.isRegister },
                            'Register'
                        )
                    )
                )
...
var _reactCookie = __webpack_require__(149);

var _reactCookie2 = _interopRequireDefault(_reactCookie);

var _reactDomFactories = __webpack_require__(150);
...
module.exports = __webpack_require__.p + "a297d32a303d6f4438eff786a8140879.png";

/***/ },
/* 146 */
/***/ function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "4a6078f1955e6ad5b0ffc06b74e46ab9.png";
