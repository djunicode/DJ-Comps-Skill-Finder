        ...
        <DjangoCSRFToken/>
          ...
          <center>
            ...
            <span className="description mdl-selectfield mdl-js-selectfield">
              <label className="mdl-selectfield__label" htmlFor="hackathon_name">Hackathon name</label>&nbsp;&nbsp;&nbsp;
              </span>
            <div className="mdl-textfield mdl-js-textfield getmdl-select">
              ...
              <input type="hidden" name="hackathon_name" value={this.state.hackathon_name} />
              <label htmlFor="hackathon_name" className="mdl-textfield__label"></label>
            </div>

            <br /><br />

            <span className="description mdl-selectfield mdl-js-selectfield">
              <label className="mdl-selectfield__label" htmlFor="hackathon_date">Hackathon date</label>&nbsp;&nbsp;&nbsp;
              </span>
            <div className="mdl-textfield mdl-js-textfield getmdl-select">
              <input type="date" className="mdl-textfield__input" id="hackathon_date" value={this.state.hackathon_date} onChange={this.handleHackathon_date} />
                <input type="hidden" name="hackathon_date" value={this.state.hackathon_date} />
            </div>

            <br /><br /><br />

            <span className="description mdl-selectfield mdl-js-selectfield">
              <label className="mdl-selectfield__label" htmlFor="hackathon_desc">Hackathon description</label>
            </span>
            <br />
            <div className="mdl-textfield mdl-js-textfield getmdl-select">
              ...
              <input type="hidden" name="hackathon_desc" value={this.state.hackathon_desc} />
              <label className="mdl-textfield__label" htmlFor="hackathon_desc"></label>
            </div>

            <br /><br />

            <span className="description mdl-selectfield mdl-js-selectfield">
              <label className="mdl-selectfield__label" htmlFor="hackathon_url">Hackathon URL</label>&nbsp;&nbsp;&nbsp;
              </span>
            <div className="mdl-textfield mdl-js-textfield getmdl-select">
              ...
              <input type="hidden" name="hackathon_url" value={this.state.hackathon_url} />
              <label htmlFor="hackathon_url" className="mdl-textfield__label"></label>
            </div>
