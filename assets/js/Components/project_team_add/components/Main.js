        ...
        return (
        	<div>
        	 <form method = "POST">
              ...
              <br/>
              <div className="mdl-textfield mdl-js-textfield getmdl-select">
              <textarea className="mdl-textfield__input" value={this.state.projdesc} onChange={this.handleProjdesc} type="text" rows= "8" id="projd" placeHolder="This is what applicants will see as your project description. Keep it updated and clearly state your requirements."></textarea>
